document.addEventListener('DOMContentLoaded', function() {
    ...
    function runMyScript() {
        ...
        // backdrop-filter on #command-blur can't see through the titlebar's
        // drag-region compositing layer, so blur it directly instead.
        targetDiv.classList.add('command-blur-active');
    ...
    function handleEscape() {
        ...
        document.querySelector(".monaco-workbench").classList.remove('command-blur-active');
